...
function ada(){
	let el = g(".green");
	change_element(el, 0, ["style", "background-color", "green", "border", "solid 3px pink"], ["txt", "AAAAA"], ["add_class", "green_box"], ["set_property", "--width", "200px"], ["dataset", "width", "300px"]);
	//change_element(el, "", "txt", "aaa");
}
//load(ada);